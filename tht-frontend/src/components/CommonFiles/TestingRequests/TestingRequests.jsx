...
const TestingRequests = () => {
	...
	const togglePasswordVisibility = (testUrl) => {
		...
		setIconClass(
			testUrl.showPass ? "bi bi-eye-fill" : "bi bi-eye-slash-fill"
		);
	};
	useEffect(() => {
						...
						<div className="col-lg-4 col-md-4 col-sm-5 col-xxl-2 col-xl-3 col-12">
							<div className="custom-input custom-input-sm mb-3">
								<div className="d-flex align-items-baseline">
									<span className="pe-3 text-nowrap">
										Status :
									</span>
									<div className="mb-3">
										<select
										...
										>
											{testRequestStates.map(
												(testRequestState) => (
													<option
														value={
															testRequestState.value
														}
														key={
															testRequestState.value
														}
								...
								{testRequests.map((testRequest) => (
									<>
										...
										>
											<td
												colSpan="5"
												className="hiddenRow m-0 field-box"
											>
												<div
													className={
														"collapse " +
