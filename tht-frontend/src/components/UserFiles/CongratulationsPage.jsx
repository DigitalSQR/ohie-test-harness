            ...
            <div className="row">
                <div className="col-md-6 col-12 col-sm-12 p-0">
                    <div className="login-bg">
                        <div className="col-10 col-md-11 col-lg-10 col-xl-8 col-xxl-6">
                            ...
                            <p className="font-size-16 mt-3">Experience streamlined OpenHIE standards compliance testing for healthcare websites. Our tool ensures precision, simplifies complexities, and empowers your projects.</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="col-md-6 col-12 col-sm-12">
                    <div className="col-xxl-7 col-xl-8 col-lg-10 col-md-11 col-11 pt-5 mx-auto text-center">
                        <div className="text-center"><img src={openhie_logo} /></div>
                        <div className="custom-scrollbar">
                            <div className="text-center my-4"><img src={congratulations_icon} /></div>
                            <h2 className="text-green">Congratulations!</h2>
                            <h6 className="my-4">Thank you for signing up for our OpenHIE Compliance Testing Tool!</h6>
                            <p>
                            ...
                            <p className="my-4">
                                Once your account is approved by our admin, you will receive another email on the registered email <span className="fw-bold">johnsmith@gmail.com</span>
                            </p>

                            <p><a className="text-blue fw-bold" href="#">RESEND</a> Verification link.</p>
                        </div>
                    </div>
                </div>
            </div>
