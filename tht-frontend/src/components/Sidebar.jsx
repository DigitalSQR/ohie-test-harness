        ...
        <div className="d-inline-flex flex-column flex-shrink-0 px-3 sidebar">
          ...
          <ul className="nav nav-pills flex-column mb-auto">
            <li className="nav-item">
              <button  className="side-items" aria-current="page">
                <span className="report w-30"></span>
                Reports
              </button>
            </li>
            <li>
              <button  className="side-items">
            ...
            <li>
              <button onClick={viewUser} className="side-items">
                <span className="settings w-30"></span>
                View User
              </button>
            </li>
            <li>
              <button  onClick={handleLogout} className="side-items">
                <span className="settings w-30"></span>
                Log out
              </button>
            </li>
            <li>
              <button className="side-items" onClick={()=>{
