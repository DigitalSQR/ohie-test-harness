                                     ...
                                     ContextInfo contextInfo) throws OperationFailedException
    {
        try {
            ...
            if (!documentReferenceAdmissionNoteOneOutcome.getCreated()) {
                ...
                return new ValidationResultInfo(testCaseName, ErrorLevel.ERROR, "Failed to create Document Reference of Admission");
            }
            ...
            if (!documentReferenceOperativeNoteOneOutcome.getCreated()) {
                ...
                return new ValidationResultInfo(testCaseName, ErrorLevel.ERROR, "Failed to create Document Reference of Operative Note");
            }
            ...
            if (!documentReferenceDischargeNoteOneOutcome.getCreated()) {
                ...
                return new ValidationResultInfo(testCaseName, ErrorLevel.ERROR, "Failed to create Document Reference of Discharge Note");
            }
            ...
            if (!operativeNoteOneOutcome.getCreated()) {
                LOGGER.error(testCaseName + "Testcase Failed when creating Composition");
                return new ValidationResultInfo(testCaseName, ErrorLevel.ERROR, "Failed to create Operative Note Composition");
            }
            ...
            if (!patientSummaryBundle.hasEntry() || !patientSummaryBundle.getType().toCode().equals("document")) {
                ...
                return new ValidationResultInfo(testCaseName, ErrorLevel.ERROR, "Bundle has no entry or not as expected entry");
            }
            for (Bundle.BundleEntryComponent entry : patientSummaryBundle.getEntry()) {
                ...
                if (entry.getResource() instanceof Patient) {
                    ...
                    if (!identifiersMatch || !nameMatches) {
                        ...
                        return new ValidationResultInfo(testCaseName, ErrorLevel.ERROR, "Wrong identifier or patient name");
                    }
