...
public interface SpecificationService {
    ...
    /**
     * Creates a new Specification.In the Specification Id, Description, and
     * Meta information may not be set in the supplied SpecificationInfo.
     *
     ...
     * @throws InvalidParameterException    SpecificationInfo or contextInfo is not
     *                                      valid
     ...
     * @throws DoesNotExistException     a SpecificationId in SpecificationIds not
     *                                   found
     * @throws InvalidParameterException invalid contextInfo
     */
