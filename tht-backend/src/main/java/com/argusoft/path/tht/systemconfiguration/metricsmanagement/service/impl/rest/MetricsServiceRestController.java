...
public class MetricsServiceRestController {
    ...
    void init() {
        try {
            ...
            LOGGER.error(ValidateConstant.UNSUPPORTED_EXCEPTION + MetricsServiceRestController.class.getSimpleName(), ex);
            ex.printStackTrace();
        }
    }
    ...
    public ResponseEntity<Object> getmetrics(
        ...
        if (map.get(registryName) == null) {
            LOGGER.error(ValidateConstant.DOES_NOT_EXIST_EXCEPTION + MetricsServiceRestController.class.getSimpleName());
