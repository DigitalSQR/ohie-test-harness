...
public class SHRF3TestCase1 implements TestCase {
    ...
    public ValidationResultInfo test(IGenericClient client, ContextInfo contextInfo) throws Exception {
        try {
            ...
            Patient patient = FHIRUtils.createPatient("John", "Doe", "M", "1990-01-01", "00001", "555-555-5555", "john.doe@example.com", "Science colony", "Delhi", "Uttar pradesh", "234214");
            ...
            Organization organization = FHIRUtils.createOrganization("Health System Inc.", "Hospital", "123 Main St", "Cityville",
                    "Stateville", "Countryland", "12345", "123-456-7890", "info@healthsystem.com", "ABC123",
                    "Health Ministry", "Level 1", true);
