...
VALUES
        ...
        (
                'testcase.cr.crf.8.1.option.1',
                'Yes, the system captures and logs details such as what was changed, when it was changed, and who made the change whenever modifications are made to the data.',
                'Yes, the system captures and logs details such as what was changed, when it was changed, and who made the change whenever modifications are made to the data.',
                'testcase.option.status.active',
                1,
                false,
        ...
        (
                'testcase.cr.crf.8.1.option.2',
                'No, the system does not capture and log details such as what was changed, when it was changed, and who made the change whenever modifications are made to the data.',
                'No, the system does not capture and log details such as what was changed, when it was changed, and who made the change whenever modifications are made to the data.',
                'testcase.option.status.active',
                2,
                false,
