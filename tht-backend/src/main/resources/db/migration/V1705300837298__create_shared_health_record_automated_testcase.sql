--create SHR automated testcases.
--
--@author dhruv
--@since 2023-09-13
INSERT INTO component (id,
                       ...
                       updated_at,
                       version)
VALUES ('component.shared.health.record',
...
INSERT INTO specification (id,
                           ...
                           updated_at,
                           version)
VALUES ('specification.shr.shrwf.1',
        'SHRWF-1',
...
VALUES ('testcase.shr.shrwf.1.1',
        ...
        1,
        false,
        'testcase.shr.shrwf.1.1~Verify Encounter has correct practitioner and patient IDs~0',
       ...
       ('testcase.shr.shrwf.2.1',
        ...
        1,
        false,
        'testcase.shr.shrwf.2.1~Verify fetch patient level clinical data from Shared Health Record~0',
        'specification.shr.shrwf.2',
        'SYSTEM_USER',
        'SYSTEM_USER',
        Now(),
       ...
       ('testcase.shr.shrf.3.1',
        ...
        1,
        false,
        'testcase.shr.shrf.3.1~Verify creation and fetch facility using XML and JSON data~0',
        'specification.shr.shrf.3',
        'SYSTEM_USER',
        'SYSTEM_USER',
        Now(),
       ...
       ('testcase.shr.shrf.5.1',
        ...
        1,
        false,
        'testcase.shr.shrf.5.1~Verify that it can return a specific known document from Shared Health Record~0',
        'specification.shr.shrf.5',
        'SYSTEM_USER',
        'SYSTEM_USER',
        Now(),
       ...
       ('testcase.shr.shrf.5.2',
        ...
        2,
        false,
        'testcase.shr.shrf.5.2~Verify that the system should also be able to offer a list of documents related to a patient from Shared Health Record~0',
        'specification.shr.shrf.5',
        'SYSTEM_USER',
        'SYSTEM_USER',
        Now(),
       ...
       ('testcase.shr.shrf.5.3',
        ...
        3,
        false,
        'testcase.shr.shrf.5.3~Verify that ff someone asks for specific information like test results, the system can filter out and provide only the relevant data from Shared Health Record~0',
        'specification.shr.shrf.5',
        'SYSTEM_USER',
        'SYSTEM_USER',
        Now(),
       ...
       ('testcase.shr.shrf.5.4',
        ...
        4,
        false,
        'testcase.shr.shrf.5.4~Verify that system should give a summary of everything it knows about a patient from Shared Health Record~0',
        'specification.shr.shrf.5',
        'SYSTEM_USER',
        'SYSTEM_USER',
        Now(),
       ...
       ('testcase.shr.shrf.8.1',
        ...
        9,
        false,
        'testcase.shr.shrf.8.1~Verify If Patient Data Is In FHIR format~0',
        'specification.shr.shrf.8',
        'SYSTEM_USER',
        'SYSTEM_USER',
        Now(),
