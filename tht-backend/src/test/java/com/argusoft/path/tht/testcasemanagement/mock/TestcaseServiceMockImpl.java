...
public class TestcaseServiceMockImpl {
    ...
    public void init() {
        ...
        createTestcase(8, "testcase.status.inactive", "Verify duplicate records", "testcase for client repository", "testcase.08", true, "specification.12", userId,"CRF1TestCase1");
    }
