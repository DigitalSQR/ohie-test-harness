...
public class SpecificationServiceMockImpl {
    ...
    public void init() {
        ...
        createSpecification("specification.06", "Specification 6", "Specification 6", 1, "specification.status.active", "component.04", true, true, userId);
        ...
        createSpecification("specification.11", "Spec 11", "Spec 11", 2, "specification.status.draft", "component.05", true, true, userId);
    }
