...
public class SpecificationServiceMockImpl {
    ...
    public void init() {
        ...
        createSpecification("specification.01", "Specification 1", "Specification 1", 1, "specification.status.active", "component.02", userId);
        createSpecification("specification.06", "Specification 6", "Specification 6",1, "specification.status.active", "component.04", userId);
        createSpecification("specification.07", "Specification 7", "Specification 7",1, "specification.status.draft", "component.04", userId);
        createSpecification("specification.08", "Specification 8", "Specification 8",1, "specification.status.inactive", "component.04", userId);
        createSpecification("specification.09", "Test 9", "Specification 9",1, "specification.status.active", "component.05", userId);
        createSpecification("specification.10", "Spec 10", "Spec 10",1, "specification.status.draft", "component.04", userId);
        createSpecification("specification.11", "Spec 11", "Spec 11",2, "specification.status.draft", "component.05", userId);
    }

    public SpecificationEntity createSpecification(String specificationId, String name, String description, int rank, String state, String componentId, String userId) {
